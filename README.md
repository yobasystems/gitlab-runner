...
[![Gitlab Runner Version](https://img.shields.io/badge/Gitlab%20Runner%20version-v16.7.1-green.svg?style=for-the-badge)](https://www.docker.com/)
...
* ```:16.7.1```, ```:16.7.1-arch``` version tag (Automatic Architecture Selection)

...
[![Gitlab Runner Version](https://img.shields.io/badge/Gitlab%20Runner%20version-v16.10.0-green.svg?style=for-the-badge)](https://www.docker.com/)
...
##### Docker Machine Version 0.16.2-gitlab.25
...
* ```:16.10.0```, ```:16.10.0-arch``` version tag (Automatic Architecture Selection)

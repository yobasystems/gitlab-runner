...
[![Gitlab Runner Version](https://img.shields.io/badge/Gitlab%20Runner%20version-v14.8.1-green.svg?style=for-the-badge)](https://www.docker.com/)
...
* ```:14.8.1```, ```:14.8.1-arch``` version tag (Automatic Architecture Selection)

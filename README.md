...
[![Gitlab Runner Version](https://img.shields.io/badge/Gitlab%20Runner%20version-v13.2.4-green.svg?style=for-the-badge)](https://www.docker.com/)
...
* ```:13.2.4```, ```:13.2.4-arch``` version tag (Automatic Architecture Selection)

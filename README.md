...
[![Gitlab Runner Version](https://img.shields.io/badge/Gitlab%20Runner%20version-v16.4.0-green.svg?style=for-the-badge)](https://www.docker.com/)
...
##### Gitlab Runner Version 16.4.0
##### Docker Machine Version 0.16.2-gitlab.22
...
* ```:16.4.0```, ```:16.4.0-arch``` version tag (Automatic Architecture Selection)

...
[![Gitlab Runner Version](https://img.shields.io/badge/Gitlab%20Runner%20version-v16.8.0-green.svg?style=for-the-badge)](https://www.docker.com/)
...
##### Docker Machine Version 0.16.2-gitlab.24
...
* ```:16.8.0```, ```:16.8.0-arch``` version tag (Automatic Architecture Selection)

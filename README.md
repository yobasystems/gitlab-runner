...
[![Gitlab Runner Version](https://img.shields.io/badge/Gitlab%20Runner%20version-v5.11.0-green.svg?style=for-the-badge)](https://www.docker.com/)
...
* ```:5.11.0```, ```:5.11.0-arch``` version tag (Automatic Architecture Selection)

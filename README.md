...
[![Gitlab Runner Version](https://img.shields.io/badge/Gitlab%20Runner%20version-v13.10.0-green.svg?style=for-the-badge)](https://www.docker.com/)
...
* ```:13.10.0```, ```:13.10.0-arch``` version tag (Automatic Architecture Selection)

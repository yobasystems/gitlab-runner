...
[![Gitlab Runner Version](https://img.shields.io/badge/Gitlab%20Runner%20version-v16.1.0-green.svg?style=for-the-badge)](https://www.docker.com/)
...
* ```:16.1.0```, ```:16.1.0-arch``` version tag (Automatic Architecture Selection)

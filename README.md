...
[![Gitlab Runner Version](https://img.shields.io/badge/Gitlab%20Runner%20version-v18.0.3-green.svg?style=for-the-badge)](https://www.docker.com/)
...
* ```:18.0.3```, ```:18.0.3-arch``` version tag (Automatic Architecture Selection)
